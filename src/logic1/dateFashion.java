...
public class dateFashion {
    ...
    is the stylishness of your date's clothes. The result getting the table is encoded as an int value with
  ...
  /*
    If any number is 2 or below , return 0
    If any number is 8 or above , return 2
    else . return 1;
  */
